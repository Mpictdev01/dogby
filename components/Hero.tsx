      ...
      <div className="container mx-auto px-6 pt-32 lg:pt-0 flex-1 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-semibold text-green-300 tracking-wide uppercase">Zero Brain, Max Gain</span>
          </motion.div>
          ...
          <p className="text-lg text-gray-300/80 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
            The only coin you need to go directly to the moon without checking the charts. 
            Pure vibes, literally zero utility.
          </p>
          ...
          >
            <div className="flex flex-col items-start pl-2">
              <span className="text-xs text-gray-500 font-mono uppercase tracking-widest">Contract Address</span>
              <span className="text-white/90 font-mono text-sm sm:text-base truncate">{ca}</span>
            </div>
            <div className="p-2 rounded-lg bg-white/10 group-hover:bg-purple-500/20 transition-colors">
              <Copy size={18} className={clsx("text-gray-400 group-hover:text-purple-300", copied && "text-green-400")} />
            </div>
            {copied && (
              <motion.span 
